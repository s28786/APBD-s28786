...
namespace Task9.Controllers
{
    ...
    public class PatientsController : ControllerBase
    {
        ...
        public PatientsController(s28786DbContext context, IPatientService service)
        {
            _service = service;
            _context = context;
        }
        ...
        public async Task<object> GetPatientInfo(int id)
        {
            return await _service.GetPatientInfo(id);
        }
    }
}
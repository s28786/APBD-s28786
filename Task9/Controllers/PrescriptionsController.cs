...
namespace Task9.Controllers
{
    ...
    public class PrescriptionsController : ControllerBase
    {
        ...
        public PrescriptionsController(s28786DbContext context, IPrescriptionService prescriptionService)
        {
        ...
        {
            return await _service.AddPrescription(addPrescriptionCommand);
        }
    }
}
    ...
    public IActionResult Put(int id, Animal updatedAnimal)
    {
        ...
        using (SqlConnection myCon = new SqlConnection(sqlDataSource))
        {
            ...
            using (SqlCommand myCommand = new SqlCommand(query, myCon))
            {
                ...
                myCommand.Parameters.AddWithValue("@Name", updatedAnimal.Name);
                myCommand.Parameters.AddWithValue("@Description", updatedAnimal.Description);
                myCommand.Parameters.AddWithValue("@Category", updatedAnimal.Category);
                myCommand.Parameters.AddWithValue("@Area", updatedAnimal.Area);
                myReader = myCommand.ExecuteReader();
                table.Load(myReader);
                myReader.Close();
                myCon.Close();
